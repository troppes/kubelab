...
//+kubebuilder:rbac:groups=kubelab.kubelab.local,resources=students,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=kubelab.kubelab.local,resources=students/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=kubelab.kubelab.local,resources=students/finalizers,verbs=update
